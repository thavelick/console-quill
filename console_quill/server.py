...
def main():
    parser = argparse.ArgumentParser(
        description="Console Quill - Capture console.log messages from web pages"
    )
    ...
    try:
        ...
        print(
            f'Include this script in your HTML: <script src="http://localhost:{args.port}/console-quill.js"></script>'
        )
